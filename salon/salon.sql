...
--
-- Name: appointments fk_sevice; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fk_sevice FOREIGN KEY (service_id) REFERENCES public.services(service_id);
